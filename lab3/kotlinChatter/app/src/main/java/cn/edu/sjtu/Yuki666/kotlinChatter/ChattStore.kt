...
object ChattStore {
    const val nFields = 5
    val serverUrl = "https://121.40.250.82/"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                if (response.isSuccessful) {
                    ...
                    completion("Posting failed (${response.code})")
                }
            }
        })
    }
                ...
                if (response.isSuccessful) {
                    ...
                    for (i in 0 until chattsReceived.length()) {
                        ...
                        if (chattEntry.length() == nFields) {
                            ...
                            Log.e("getChatts", "Received unexpected number of fields " +
                                    chattEntry.length().toString() + " instead of " + nFields.toString())
                        }
                    }
                }
            }
